...
namespace CineTEC_API.Controllers
{
  ...
  public class ClienteController : ControllerBase
  {
    ...
    {
      string query = @"
          select cedulacliente, nombrecliente1, nombrecliente2, apellidocliente1, apellidocliente2, fechanacimiento, numerotelefono, edad, cedulaempleado
          from cliente
          ";
    ...
    {
      string query = @"
          insert into cliente(cedulacliente, nombrecliente1, nombrecliente2, apellidocliente1, apellidocliente2, fechanacimiento, numerotelefono, edad, cedulaempleado)
          values (@cedulacliente, @nombrecliente1, @nombrecliente2, @apellidocliente1, @apellidocliente2, @fechanacimiento, @numerotelefono, @edad, @cedulaempleado)
          ";
      DataTable table = new DataTable();
      string sqlDataSource = _configuration.GetConnectionString(cadenaDeConexion);
      NpgsqlDataReader myReader;
      using (NpgsqlConnection myCon = new NpgsqlConnection(sqlDataSource))
      {
        ...
        using (NpgsqlCommand myComand = new NpgsqlCommand(query, myCon))
        {
          ...
          myComand.Parameters.AddWithValue("@edad", cliente.edad);
          myComand.Parameters.AddWithValue("@cedulaempleado", cliente.cedulaempleado);
          myReader = myComand.ExecuteReader();
          table.Load(myReader);
          myReader.Close();
          myCon.Close();
