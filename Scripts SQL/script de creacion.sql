...
/** LLAVES FORANEAS CON RESPECTO A BUTACA**/
ALTER TABLE FACTURA
ADD CONSTRAINT FACTURA_BUTACA_FK FOREIGN KEY (NumeroDeAsiento)
REFERENCES BUTACA(NumeroDeAsiento);

ALTER TABLE BUTACAXFUNCION
ADD CONSTRAINT BUTACAXFUNCION_BUTACA_FK FOREIGN KEY (NumeroDeAsiento)
REFERENCES BUTACA(NumeroDeAsiento);